                ...
                <MetizContentScreen>
                    ...
                    <ScrollView >
                        ...
                        <View style={style.notification}>
                            <Text style={style.saveButtonText}>Thông báo: bạn chưa đăng ký thẻ thành viên hoặc có thẻ thành viên mà chưa liên kết với tài khoản!</Text>
                            <Text style={[style.saveButtonText,{marginTop:10}]}>Nếu bạn đã có thẻ vui lòng nhập mã thẻ vào ô bên dưới để liên kết với tài khoản.</Text>
                        </View>
